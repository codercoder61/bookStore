...
<div id="main">
        ...
        <aside>
          ...
          <div id="pl">
              <h1>Dernières demandes effectuées</h1>
              @foreach ($demande as $item)
                              <div style="margin-top: 20px;margin-left: 20px;">

                <p style="color:#fff;display:inline-block;margin-right:5px;">{{ $item['etd']->prenom }} {{ $item['etd']->nom }} a demandé d'emprunter un livre {{ $item['liv']->NOM }}</p><a href="accepteDemande/{{$item['id_dem']}}"><button class='abc'>Confirmer</button></a><a href="suppDemande/{{$item['id_dem']}}"><button>Supprimer</button></a><br/>
                  </div>
              @endforeach
